            ...
            if (intersection(r, P, N, albedo, t, miroir, transp,id)) {// en cas d'intersection avec un objet de la scene
                ...
                if (miroir) { // si c'est un miroir
                    ...
                    if (transp) { // si  il est transparent
                        ...
                        if (intersection(Rayonombre, Pombre, Nombre, albedoombre, tombre, miroirombre, transombre,idombre) && tombre < normePxp-0.0001) {//s'il y a intersection avant d'arriver e la source de lumiere
...
#pragma omp parallel for schedule(dynamic,1)
	...
	stbi_write_png("ombredouce_amelioree.png", W, H, 3, &image[0], 0);
