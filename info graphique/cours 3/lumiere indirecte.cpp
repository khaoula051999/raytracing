...
Vecteur aleatoire(const Vecteur& N) { //Renvoie un vecteur z*N+x*T1+y*T2, avec (N,T1,T2) un repere, et x,y,z aleatoires suivant une loi de probabilite cosinus (le rayon a plus de chance d'etre proche de N)
...
#pragma omp parallel for schedule(dynamic,1)
	...
	stbi_write_png("lumiere_indirect.png", W, H, 3, &image[0], 0);
